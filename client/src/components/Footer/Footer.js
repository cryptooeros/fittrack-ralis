...
export default function Footer() {
  return (
    <footer className="bg-lime">
      <div className="relative mx-auto max-w-7xl overflow-hidden py-20 px-6 sm:py-24 lg:px-8">
        <nav className="-mb-6 columns-2 sm:flex sm:justify-center sm:space-x-12" aria-label="Footer">
          {navigation.main.map((item) => (
            <div key={item.name} className="pb-4 px-12">
              <a href={item.href} className="text-lg leading-6 text-gray hover:text-gray-900">
                {item.name}
              </a>
            </div>
          ))}
        ...
        <p className="mt-10 -mb-10 text-center text-s leading-5 text-gray-500">
